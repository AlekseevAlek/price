...
class PriceMachine():
    ...
    def export_to_html(self, output_file_path=r'C:\Users\raveg\PycharmProjects\pythonProject30\output.html'):
        if self.data:
...
price_machine.load_prices(r'C:\Users\raveg\PycharmProjects\pythonProject30')
